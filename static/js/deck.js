!function(e) {
    ...
    function r(t, r) {
        ...
        n.onreadystatechange = n.onload = function() {
            var e = n.readyState;
            !r.done && (!e || /loaded|complete/.test(e)) && (r.done = !0,
            r())
        }
        ,
    ...
    function n(e, t) {
        ...
        void r(e.url, function() {
            e.state = E,
            t && t(),
            l(v[e.name], function(e) {
                d(e)
            }),
    ...
    function s(e) {
        ...
        var t;
        for (var r in e) {
            if (e.hasOwnProperty(r) && e[r].state != E)
                return !1;
            t = !0
        }
        return t
    ...
    function u(e) {
        ...
        var n = y[t.name];
        return n && n.url === t.url ? n : (y[t.name] = t,
        t)
    }
    function c(e) {
        var t = e.split("/")
    ...
    var p, h, m = e.documentElement, f = [], g = [], v = {}, y = {}, b = e.createElement("script").async === !0 || "MozAppearance"in e.documentElement.style || window.opera, w = window.head_conf && head_conf.head || "head", x = window[w] = window[w] || function() {
    ...
    x.ready = function(t, r) {
        ...
        "string" != typeof t || !o(r))
            return x;
        var n = y[t];
        if (n && n.state == E || "ALL" == t && s() && h)
            return d(r),
            x;
        var a = v[t];
        return a ? a.push(r) : a = v[t] = [r],
        x
    }
    ,
    x.ready(e, function() {
    ...
    !e.readyState && e.addEventListener && (e.readyState = "loading",
    e.addEventListener("DOMContentLoaded", handler = function() {
    ...
    return function e(t, r, n) {
        ...
        2: [function(e, t) {
            ...
            function n(e, t, n) {
                ...
                a.lastIndex = n;
                var i = a.exec(t);
                return null == i[i.length - 1] ? (i.length = i.length - 1,
                i) : null
            }
            t.exports = n
        }
        ...
        4: [function(e, t) {
            ...
            r.prototype.unget = function(e) {
                for (this.stack.push(e); 0 !== this.discardedWhiteSpace.length; )
        ...
        5: [function(e, t) {
            function r(e) {
                ...
                this.font = e.font,
                this.parentStyle = void 0 === e.parentStyle ? e.style : e.parentStyle,
                this.parentSize = void 0 === e.parentSize ? e.size : e.parentSize
            }
        ...
        6: [function(e, t) {
            function r(e, t) {
                ...
                if (t && t.lexer && t.start <= t.end) {
                    ...
                    n = t.start,
                    a = t.end,
                    i += n === s.length ? " at end of input: " : " at position " + (n + 1) + ": ";
                ...
                var c = new Error(i);
                return c.name = "ParseError",
                c.__proto__ = r.prototype,
                c.position = n,
                c
            }
        ...
        7: [function(e, t) {
            ...
            r.prototype.expect = function(e, t) {
                if (this.nextToken.text !== e)
                    throw new d("Expected '" + e + "', got '" + this.nextToken.text + "'",this.nextToken);
                t !== !1 && this.consume()
            }
            ,
            ...
            r.prototype.parseExpression = function(e, t) {
                for (var r = []; ; ) {
                    ...
                    if (-1 !== h.indexOf(n.text))
                        break;
                    if (t && n.text === t)
                        break;
                    if (e && a[n.text] && a[n.text].infix)
                        break;
            ...
            r.prototype.handleInfixNodes = function(e) {
                for (var t, r = -1, n = 0; n < e.length; n++) {
                    ...
                    if ("infix" === a.type) {
                        if (-1 !== r)
                            throw new d("only one infix operator per group",a.value.token);
                        r = n,
                        t = a.value.replaceWith
                    }
                }
                if (-1 !== r) {
                    var i, s, o = e.slice(0, r), l = e.slice(r + 1);
                    i = 1 === o.length && "ordgroup" === o[0].type ? o[0] : new p("ordgroup",o,this.mode),
                    s = 1 === l.length && "ordgroup" === l[0].type ? l[0] : new p("ordgroup",l,this.mode);
            ...
            r.prototype.parseImplicitGroup = function() {
                ...
                if ("\\begin" === r) {
                    ...
                    if (!i.hasOwnProperty(o))
                        throw new d("No such environment: " + o,s.value.nameGroup);
                    var u = i[o]
                    ...
                    if (y.value.name !== o)
                        throw new d("Mismatch: \\begin{" + o + "} matched by \\end{" + y.value.name + "}",v);
                    return m.position = y.position,
                    m
                }
                return l.contains(f, r) ? (t = this.parseExpression(!1),
                new p("sizing",{
                    size: "size" + (l.indexOf(f, r) + 1),
                    value: t
                },this.mode)) : l.contains(g, r) ? (t = this.parseExpression(!0),
                new p("styling",{
                ...
                e) {
                    if (e.isFunction) {
                        ...
                        if ("text" === this.mode && !r.allowedInText)
                            throw new d("Can't use function '" + t + "' in text mode",e.token);
            ...
            r.prototype.parseArguments = function(e, t) {
                ...
                for (var i = t.greediness, s = [this.pos], o = [], l = 0; r > l; l++) {
                    var u, c = this.nextToken, p = t.argTypes && t.argTypes[l];
                    if (l < t.numOptionalArgs) {
                        if (u = p ? this.parseGroupOfType(p, !0) : this.parseGroup(!0),
                        !u) {
                            o.push(null),
                            s.push(this.pos);
                            continue
                        }
                    } else if (u = p ? this.parseGroupOfType(p) : this.parseGroup(),
                    !u) {
                        if (this.settings.throwOnError || "\\" !== this.nextToken.text[0])
                            throw new d("Expected group after '" + e + "'",c);
                    ...
                    if (u.isFunction) {
                        ...
                        if (!(m > i))
                            throw new d("Got function '" + u.result + "' as argument to '" + e + "'",c);
            ...
            r.prototype.parseStringGroup = function(e, t) {
                ...
                for (var n = "", a = this.nextToken, i = a; this.nextToken.text !== (t ? "]" : "}"); ) {
                    if ("EOF" === this.nextToken.text)
                        throw new d("Unexpected end of input in " + e,a.range(this.nextToken, n));
                    i = this.nextToken,
                    n += i.text,
                    this.consume()
                }
            ...
            r.prototype.parseRegexGroup = function(e, t) {
                var r = this.mode;
                this.mode = "text";
                for (var n = this.nextToken, a = n, i = ""; "EOF" !== this.nextToken.text && e.test(i + this.nextToken.text); )
                    a = this.nextToken,
                    i += a.text,
                    this.consume();
                if ("" === i)
                    throw new d("Invalid " + t + ": '" + n.text + "'",n);
                return this.mode = r,
                n.range(a, i)
            }
            ,
            ...
            r.prototype.parseSizeGroup = function(e) {
                var t;
                if (t = e || "{" === this.nextToken.text ? this.parseStringGroup("size", e) : this.parseRegexGroup(/^[-+]? *(?:$|\d+|\d+\.\d*|\.\d*) *[a-z]{0,2}$/, "size"),
                !t)
                    return null;
                ...
                if ("em" !== a.unit && "ex" !== a.unit && "mu" !== a.unit)
                    throw new d("Invalid unit: '" + a.unit + "'",t);
            ...
            r.prototype.parseGroup = function(e) {
                ...
                if (this.nextToken.text === (e ? "[" : "{")) {
                    ...
                    new n(new p("ordgroup",r,this.mode,t,a),!1)
                }
            ...
            r.prototype.formLigatures = function(e) {
                ...
                for (t = 0; r > t; ++t) {
                    var n = e[t]
                      , a = n.value;
                    "-" === a && "-" === e[t + 1].value && (r > t + 1 && "-" === e[t + 2].value ? (e.splice(t, 3, new p("textord","---","text",n,e[t + 2])),
                    r -= 2) : (e.splice(t, 2, new p("textord","--","text",n,e[t + 1])),
                    r -= 1)),
                    "'" !== a && "`" !== a || e[t + 1].value !== a || (e.splice(t, 2, new p("textord",a + a,"text",n,e[t + 1])),
                    r -= 1)
                }
            }
            ,
            r.prototype.parseSymbol = function() {
                ...
                return a[e.text] ? (this.consume(),
                new n(e.text,!0,e)) : o[this.mode][e.text] ? (this.consume(),
                new n(new p(o[this.mode][e.text].group,e.text,this.mode,e),!1,e)) : "text" === this.mode && u.test(e.text) ? (this.consume(),
                new n(new p("textord",e.text,this.mode,e),!1,e)) : null
            }
            ,
            r.prototype.ParseNode = p,
            t.exports = r
        }
        , {
            "./MacroExpander": 4,
        ...
        8: [function(e, t) {
            ...
            function n(e) {
                e = e || {},
                this.displayMode = r(e.displayMode, !1),
                this.throwOnError = r(e.throwOnError, !0),
                this.errorColor = r(e.errorColor, "#cc0000"),
        ...
        9: [function(e, t) {
            ...
            var n, a = e("./fontMetrics.js").sigmas, i = [{}, {}, {}];
            for (var s in a)
            ...
            var r = e("./domTree")
              ...
              , l = function(e, t, i, s, o) {
                ...
                if (u) {
                    var c = u.italic;
                    "text" === i && (c = 0),
                    l = new r.symbolNode(e,u.height,u.depth,c,u.skew,o)
                } else
                    "undefined" != typeof console && console.warn("No character metrics for '" + e + "' in style '" + t + "'"),
                    l = new r.symbolNode(e,0,0,0,0,o);
                return s && (s.style.isTight() && l.classes.push("mtight"),
                s.getColor() && (l.style.color = s.getColor())),
                l
            }
              , u = function(e, t, r, n) {
              ...
              , c = function(e, t, r, n, a) {
                if ("mathord" === a)
                    return d(e, t, r, n);
                if ("textord" === a)
                    return l(e, "Main-Regular", t, r, n.concat(["mathrm"]));
              ...
              , h = function(e) {
                ...
                if (e.children)
                    for (var a = 0; a < e.children.length; a++)
                        e.children[a].height > t && (t = e.children[a].height),
                        e.children[a].depth > r && (r = e.children[a].depth),
                        e.children[a].maxFontSize > n && (n = e.children[a].maxFontSize);
                e.height = t,
                e.depth = r,
                e.maxFontSize = n
            }
              ...
              , y = function(e, t, n, a) {
                ...
                if ("individualShift" === t) {
                    ...
                    for (o = 0; o < e.length; o++)
                        d -= "kern" === e[o].type ? e[o].size : e[o].elem.height + e[o].elem.depth;
                    i = d
                } else
                    i = "bottom" === t ? -n : "shift" === t ? -e[0].elem.depth - n : "firstBaseline" === t ? -e[0].elem.depth : 0;
                var p = 0;
                for (o = 0; o < e.length; o++)
                    "elem" === e[o].type && (p = Math.max(p, e[o].elem.maxFontSize));
                var h = v(a, p)
                  , f = [];
                for (s = i,
                o = 0; o < e.length; o++)
                ...
                f.push(w);
                var x = m(["vlist"], f);
                return x.height = Math.max(s, x.height),
                x.depth = Math.max(-i, x.depth),
                x
            }
              , b = {
                size1: .5,
        ...
        11: [function(e, t) {
            var r = e("./ParseError")
              ...
              , m = function(e, t, r) {
                ...
                for (i = 0; i < n.length; i++)
                    ...
                    m.push(n[i]),
                    n.splice(i, 1),
                    i--) : m && (n[i]instanceof s.symbolNode && (n[i] = u([].concat(n[i].classes), [n[i]])),
                    a.prependChildren(n[i], m),
                    m = null);
                for (m && Array.prototype.push.apply(n, m),
                i = 0; i < n.length; i++)
                    d(n[i]) && (p(n[i - 1], r) || h(n[i + 1], r)) && (n[i].classes[0] = "mord");
                return n
            }
              , f = function(e) {
                if (e instanceof s.documentFragment) {
                    if (e.children.length)
                        return f(e.children[e.children.length - 1])
                } else if (l.contains(["mord", "mop", "mbin", "mrel", "mopen", "mclose", "mpunct", "minner"], e.classes[0]))
                    return e.classes[0];
                return null
            }
              , g = function(e, t) {
            ...
            ,
            w.text = function(e, t) {
                for (var r = t.withFont(e.value.style), n = m(e.value.body, r, !0), a = 0; a < n.length - 1; a++)
                    n[a].tryCombine(n[a + 1]) && (n.splice(a + 1, 1),
                    a--);
            ...
            w.supsub = function(e, t) {
                ...
                var r, i, l, c, d, p = k(e.value.base, t.reset()), h = t.style;
                e.value.sup && (d = t.withStyle(h.sup()),
                l = k(e.value.sup, d),
                r = u([h.reset(), h.sup().cls()], [l], d)),
                e.value.sub && (d = t.withStyle(h.sub()),
                c = k(e.value.sub, d),
                i = u([h.reset(), h.sub().cls()], [c], d));
                var m, v;
                y(e.value.base) ? (m = 0,
                v = 0) : (m = p.height - h.metrics.supDrop,
                v = p.depth + h.metrics.subDrop);
                var b;
                b = h === n.DISPLAY ? h.metrics.sup1 : h.cramped ? h.metrics.sup3 : h.metrics.sup2;
                var x, A = n.TEXT.sizeMultiplier * h.sizeMultiplier, S = .5 / o.metrics.ptPerEm / A + "em";
                if (e.value.sup)
                    if (e.value.sub) {
                        m = Math.max(m, b, l.depth + .25 * h.metrics.xHeight),
                        v = Math.max(v, h.metrics.sub2);
                        ...
                        p instanceof s.symbolNode && (x.children[0].style.marginLeft = -p.italic + "em"),
                        x.children[0].style.marginRight = S,
                        x.children[1].style.marginRight = S
                    } else
                        m = Math.max(m, b, l.depth + .25 * h.metrics.xHeight),
                        x = a.makeVList([{
                            type: "elem",
                    ...
                    v = Math.max(v, h.metrics.sub1, c.height - .8 * h.metrics.xHeight),
                    x = a.makeVList([{
                        type: "elem",
                        elem: i
                    }], "shift", v, t),
            ...
            w.genfrac = function(e, t) {
                ...
                var s, l = r.fracNum(), c = r.fracDen();
                s = t.withStyle(l);
                var d = k(e.value.numer, s)
                  , p = u([r.reset(), l.cls()], [d], s);
                s = t.withStyle(c);
                var h, m = k(e.value.denom, s), f = u([r.reset(), c.cls()], [m], s);
                h = e.value.hasBarLine ? o.metrics.defaultRuleThickness / t.style.sizeMultiplier : 0;
                var g, v, y;
                r.size === n.DISPLAY.size ? (g = r.metrics.num1,
                v = h > 0 ? 3 * h : 7 * o.metrics.defaultRuleThickness,
                y = r.metrics.denom1) : (h > 0 ? (g = r.metrics.num2,
                v = h) : (g = r.metrics.num3,
                v = 3 * o.metrics.defaultRuleThickness),
                y = r.metrics.denom2);
                var w;
                if (0 === h) {
                    ...
                    g - d.depth - (A + .5 * h) < v && (g += v - (g - d.depth - (A + .5 * h))),
                    A - .5 * h - (m.height - y) < v && (y += v - (A - .5 * h - (m.height - y)));
                ...
                w.height *= r.sizeMultiplier / t.style.sizeMultiplier,
                w.depth *= r.sizeMultiplier / t.style.sizeMultiplier;
                var L;
                L = r.size === n.DISPLAY.size ? r.metrics.delim1 : r.metrics.delim2;
                var M, z;
                return M = null == e.value.leftDelim ? b(t, ["mopen"]) : i.customSizedDelim(e.value.leftDelim, L, !0, t.withStyle(r), e.mode, ["mopen"]),
                z = null == e.value.rightDelim ? b(t, ["mclose"]) : i.customSizedDelim(e.value.rightDelim, L, !0, t.withStyle(r), e.mode, ["mclose"]),
                u(["mord", t.style.reset(), r.cls()], [M, u(["mfrac"], [w]), z], t)
            }
            ;
            var x = function(e, t) {
                var r = e.number;
                return "ex" === e.unit ? r *= t.metrics.emPerEx : "mu" === e.unit && (r /= 18),
                r
            };
            w.array = function(e, t) {
                var n, i, s = e.value.body.length, c = 0, d = new Array(s), p = t.style, h = 1 / o.metrics.ptPerEm, m = 5 * h, f = 12 * h, g = l.deflt(e.value.arraystretch, 1), v = g * f, y = .7 * v, b = .3 * v, w = 0;
                for (n = 0; n < e.value.body.length; ++n) {
                    ...
                    for (i = 0; i < A.length; ++i) {
                        var M = k(A[i], t);
                        E < M.depth && (E = M.depth),
                        S < M.height && (S = M.height),
                        L[i] = M
                    }
                    var z = 0;
                    e.value.rowGaps[n] && (z = x(e.value.rowGaps[n].value, p),
                    z > 0 && (z += b,
                    z > E && (E = z),
                    z = 0)),
                    L.height = S,
                ...
                var T, N, q = w / 2 + p.metrics.axisHeight, C = e.value.cols || [], P = [];
                for (i = 0,
                N = 0; c > i || N < C.length; ++i,
                ++N) {
                    for (var R = C[N] || {}, D = !0; "separator" === R.type; ) {
                        if (D || (T = u(["arraycolsep"], []),
                        T.style.width = o.metrics.doubleRuleSep + "em",
                        P.push(T)),
                        "|" !== R.separator)
                            throw new r("Invalid separator type: " + R.separator);
                        var I = u(["vertical-separator"], []);
                        I.style.height = w + "em",
                        I.style.verticalAlign = -(w - q) + "em",
                        P.push(I),
                        N++,
                        R = C[N] || {},
                        D = !1
                    ...
                    if (!(i >= c)) {
                        var O;
                        (i > 0 || e.value.hskipBeforeAndAfter) && (O = l.deflt(R.pregap, m),
                        0 !== O && (T = u(["arraycolsep"], []),
                        T.style.width = O + "em",
                        P.push(T)));
                        var B = [];
                        ...
                        B = a.makeVList(B, "individualShift", null, t),
                        B = u(["col-align-" + (R.align || "c")], [B]),
                        P.push(B),
                        (c - 1 > i || e.value.hskipBeforeAndAfter) && (O = l.deflt(R.postgap, m),
                        0 !== O && (T = u(["arraycolsep"], []),
                        T.style.width = O + "em",
                        P.push(T)))
                    }
            ...
            w.op = function(e, t) {
                ...
                if (e.value.symbol) {
                    ...
                    h = a.makeSymbol(e.value.body, v, "math", t, ["mop", "op-symbol", p ? "large-op" : "small-op"]),
                    f = (h.height - h.depth) / 2 - c.metrics.axisHeight * c.sizeMultiplier,
                    g = h.italic
                } else if (e.value.value) {
                    var y = m(e.value.value, t, !0);
                    h = u(["mop"], y, t)
                } else {
                    for (var b = [], w = 1; w < e.value.body.length; w++)
                        b.push(a.mathsym(e.value.body[w], e.mode));
                    h = u(["mop"], b, t)
                }
                if (s) {
                    h = u([], [h]);
                    ...
                    if (r) {
                        L = t.withStyle(c.sup());
                        var M = k(r, L);
                        x = u([c.reset(), c.sup().cls()], [M], L),
                        A = Math.max(o.metrics.bigOpSpacing1, o.metrics.bigOpSpacing3 - M.depth)
                    }
                    if (i) {
                        L = t.withStyle(c.sub());
                        var z = k(i, L);
                        S = u([c.reset(), c.sub().cls()], [z], L),
                        E = Math.max(o.metrics.bigOpSpacing2, o.metrics.bigOpSpacing4 - z.height)
                    }
                    var T, N, q;
                    if (r)
                        if (i) {
                            if (!r && !i)
                                return h;
                            q = o.metrics.bigOpSpacing5 + S.height + S.depth + E + h.depth + f,
                            T = a.makeVList([{
                                type: "kern",
                            ...
                            T.children[0].style.marginLeft = -g + "em",
                            T.children[2].style.marginLeft = g + "em"
                        } else
                            q = h.depth + f,
                            T = a.makeVList([{
                                type: "elem",
                            ...
                            T.children[1].style.marginLeft = g + "em";
                    else
                        N = h.height - f,
                        T = a.makeVList([{
                            type: "kern",
                ...
                return e.value.symbol && (h.style.top = f + "em"),
                h
            }
            ,
            w.mod = function(e, t) {
                var r = [];
                if ("bmod" === e.value.modType ? (t.style.isTight() || r.push(u(["mspace", "negativemediumspace"], [], t)),
                r.push(u(["mspace", "thickspace"], [], t))) : r.push(t.style.size === n.DISPLAY.size ? u(["mspace", "quad"], [], t) : "mod" === e.value.modType ? u(["mspace", "twelvemuspace"], [], t) : u(["mspace", "eightmuspace"], [], t)),
                ("pod" === e.value.modType || "pmod" === e.value.modType) && r.push(a.mathsym("(", e.mode)),
                "pod" !== e.value.modType) {
                    var i = [a.mathsym("m", e.mode), a.mathsym("o", e.mode), a.mathsym("d", e.mode)];
                    "bmod" === e.value.modType ? (r.push(u(["mbin"], i, t)),
                    r.push(u(["mspace", "thickspace"], [], t)),
                    t.style.isTight() || r.push(u(["mspace", "negativemediumspace"], [], t))) : (Array.prototype.push.apply(r, i),
                    r.push(u(["mspace", "sixmuspace"], [], t)))
                }
                return e.value.value && Array.prototype.push.apply(r, m(e.value.value, t, !1)),
                ("pod" === e.value.modType || "pmod" === e.value.modType) && r.push(a.mathsym(")", e.mode)),
                a.makeFragment(r)
            }
            ,
            w.katex = function(e, t) {
                ...
                n.height = .75 * (n.height + .2),
                n.depth = .75 * (n.height - .2);
            ...
            w.sizing = function(e, t) {
                ...
                for (var s = 0; s < r.length; s++) {
                    ...
                    0 > o ? (r[s].classes.push("sizing", "reset-" + t.size, e.value.size, n.cls()),
                    r[s].maxFontSize = i) : r[s].classes[o + 1] === "reset-" + e.value.size && (r[s].classes[o + 1] = "reset-" + t.size)
                }
            ...
            w.leftright = function(e, t) {
                for (var r = m(e.value.body, t.reset(), !0), n = 0, a = 0, s = !1, o = 0; o < r.length; o++)
                    r[o].isMiddle ? s = !0 : (n = Math.max(r[o].height, n),
                    a = Math.max(r[o].depth, a));
                var l = t.style;
                n *= l.sizeMultiplier,
                a *= l.sizeMultiplier;
                var c;
                if (c = "." === e.value.left ? b(t, ["mopen"]) : i.leftRightDelim(e.value.left, n, a, t, e.mode, ["mopen"]),
                r.unshift(c),
                s)
                    for (o = 1; o < r.length; o++)
                        r[o].isMiddle && (r[o] = i.leftRightDelim(r[o].isMiddle.value, n, a, r[o].isMiddle.options, e.mode, []));
                var d;
                return d = "." === e.value.right ? b(t, ["mclose"]) : i.leftRightDelim(e.value.right, n, a, t, e.mode, ["mclose"]),
                r.push(d),
                u(["minner", l.cls()], r, t)
            }
            ,
            w.middle = function(e, t) {
                var r;
                return "." === e.value.value ? r = b(t, []) : (r = i.sizedDelim(e.value.value, 1, t, e.mode, []),
                r.isMiddle = {
                    value: e.value.value,
                    options: t
                }),
            ...
            w.kern = function(e, t) {
                var r = u(["mord", "rule"], [], t)
                  , n = t.style
                  , a = 0;
                return e.value.dimension && (a = x(e.value.dimension, n)),
                a /= n.sizeMultiplier,
            ...
            w.accent = function(e, t) {
                ...
                f.children[1].style.marginLeft = 2 * o + "em";
                var g = u(["mord", "accent"], [f], t);
                return r ? (r.children[0] = g,
            ...
            var k = function(e, t) {
                ...
                if (w[e.type]) {
                    ...
                    return t.style !== t.parentStyle && (n = t.style.sizeMultiplier / t.parentStyle.sizeMultiplier,
                    i.height *= n,
                    i.depth *= n),
                    t.size !== t.parentSize && (n = a.sizingMultiplier[t.size] / a.sizingMultiplier[t.parentSize],
                    i.height *= n,
                    i.depth *= n),
                    i
                }
        ...
        12: [function(e, t) {
            var r = e("./buildCommon")
              ...
              , u = r.fontMap
              , c = function(e, t) {
                return s[t][e] && s[t][e].replace && (e = s[t][e].replace),
                new a.TextNode(e)
            }
              , d = function(e, t) {
                var r = t.font;
            ...
            p.mathord = function(e, t) {
                var r = new a.MathNode("mi",[c(e.value, e.mode)])
                  , n = d(e, t);
                return n && r.setAttribute("mathvariant", n),
                r
            }
            ,
            p.textord = function(e, t) {
                var r, n = c(e.value, e.mode), i = d(e, t) || "normal";
                return /[0-9]/.test(e.value) ? (r = new a.MathNode("mn",[n]),
                t.font && r.setAttribute("mathvariant", i)) : (r = new a.MathNode("mi",[n]),
                r.setAttribute("mathvariant", i)),
                r
            }
            ,
            p.bin = function(e) {
            ...
            p.color = function(e, t) {
                ...
                return n.setAttribute("mathcolor", e.value.color),
                n
            }
            ,
            p.supsub = function(e, t) {
                var r = [m(e.value.base, t)];
                e.value.sub && r.push(m(e.value.sub, t)),
                e.value.sup && r.push(m(e.value.sup, t));
                var n;
            ...
            p.middle = function(e) {
                ...
                return t.setAttribute("fence", "true"),
                t
            }
            ,
            ...
            p.spacing = function(e) {
                var t;
                return "\\ " === e.value || "\\space" === e.value || " " === e.value || "~" === e.value ? t = new a.MathNode("mtext",[new a.TextNode("\xa0")]) : (t = new a.MathNode("mspace"),
                t.setAttribute("width", r.spacingFunctions[e.value].size)),
                t
            }
            ,
            p.op = function(e, t) {
            ...
            p.mod = function(e, t) {
                var r = [];
                if (("pod" === e.value.modType || "pmod" === e.value.modType) && r.push(new a.MathNode("mo",[c("(", e.mode)])),
                "pod" !== e.value.modType && r.push(new a.MathNode("mo",[c("mod", e.mode)])),
                e.value.value) {
                    var n = new a.MathNode("mspace");
                    n.setAttribute("width", "0.333333em"),
                    r.push(n),
                    r = r.concat(h(e.value.value, t))
                }
                return ("pod" === e.value.modType || "pmod" === e.value.modType) && r.push(new a.MathNode("mo",[c(")", e.mode)])),
                new a.MathNode("mo",r)
            }
            ,
            p.katex = function() {
            ...
            p.delimsizing = function(e) {
                ...
                return "mopen" === e.value.mclass || "mclose" === e.value.mclass ? r.setAttribute("fence", "true") : r.setAttribute("fence", "false"),
                r
            }
            ,
            p.styling = function(e, t) {
                var r = h(e.value.value, t)
                  ...
                  , s = i[e.value.style];
                return n.setAttribute("scriptlevel", s[0]),
            ...
            p.sizing = function(e, t) {
                ...
                return i.setAttribute("mathsize", r.sizingMultiplier[e.value.size] + "em"),
                i
            }
            ,
            ...
            p.llap = function(e, t) {
                ...
                return r.setAttribute("lspace", "-1width"),
        ...
        14: [function(e, t) {
            var r = e("./ParseError")
              ...
              , f = function(e, t, r, i, s, o) {
                ...
                p = null;
                var g = "Size1-Regular";
                "\\uparrow" === e ? h = f = "\u23d0" : "\\Uparrow" === e ? h = f = "\u2016" : "\\downarrow" === e ? c = h = "\u23d0" : "\\Downarrow" === e ? c = h = "\u2016" : "\\updownarrow" === e ? (c = "\\uparrow",
                h = "\u23d0",
                f = "\\downarrow") : "\\Updownarrow" === e ? (c = "\\Uparrow",
                h = "\u2016",
                f = "\\Downarrow") : "[" === e || "\\lbrack" === e ? (c = "\u23a1",
                h = "\u23a2",
                f = "\u23a3",
                g = "Size4-Regular") : "]" === e || "\\rbrack" === e ? (c = "\u23a4",
                h = "\u23a5",
                f = "\u23a6",
                g = "Size4-Regular") : "\\lfloor" === e ? (h = c = "\u23a2",
                f = "\u23a3",
                g = "Size4-Regular") : "\\lceil" === e ? (c = "\u23a1",
                h = f = "\u23a2",
                g = "Size4-Regular") : "\\rfloor" === e ? (h = c = "\u23a5",
                f = "\u23a6",
                g = "Size4-Regular") : "\\rceil" === e ? (c = "\u23a4",
                h = f = "\u23a5",
                g = "Size4-Regular") : "(" === e ? (c = "\u239b",
                h = "\u239c",
                f = "\u239d",
                ...
                h = "\u239f",
                f = "\u23a0",
                g = "Size4-Regular") : "\\{" === e || "\\lbrace" === e ? (c = "\u23a7",
                p = "\u23a8",
                f = "\u23a9",
                h = "\u23aa",
                g = "Size4-Regular") : "\\}" === e || "\\rbrace" === e ? (c = "\u23ab",
                p = "\u23ac",
                f = "\u23ad",
                h = "\u23aa",
                g = "Size4-Regular") : "\\lgroup" === e ? (c = "\u23a7",
                f = "\u23a9",
                h = "\u23aa",
                g = "Size4-Regular") : "\\rgroup" === e ? (c = "\u23ab",
                f = "\u23ad",
                h = "\u23aa",
                g = "Size4-Regular") : "\\lmoustache" === e ? (c = "\u23a7",
                f = "\u23ad",
                h = "\u23aa",
                g = "Size4-Regular") : "\\rmoustache" === e ? (c = "\u23ab",
                f = "\u23a9",
                h = "\u23aa",
                g = "Size4-Regular") : "\\surd" === e && (c = "\ue001",
                f = "\u23b7",
                h = "\ue000",
                g = "Size4-Regular");
                var v = u(c, g)
              ...
              , w = function(e, t, n, a, i) {
                if ("<" === e || "\\lt" === e ? e = "\\langle" : (">" === e || "\\gt" === e) && (e = "\\rangle"),
                o.contains(g, e) || o.contains(y, e))
                    return h(e, t, !1, n, a, i);
                if (o.contains(v, e))
                    return f(e, b[t], !1, n, a, i);
              ...
              , E = function(e, t, r, n) {
                for (var a = Math.min(2, 3 - n.style.size), i = a; i < r.length && "stack" !== r[i].type; i++) {
                    var s = u(e, S(r[i]))
                      , o = s.height + s.depth;
                    if ("small" === r[i].type && (o *= r[i].style.sizeMultiplier),
                    o > t)
                        return r[i]
                }
                return r[r.length - 1]
        ...
        15: [function(e, t) {
            function r(e, t, r) {
                ...
                this.style = {},
                this.attributes = {},
                r && (r.style.isTight() && this.classes.push("mtight"),
                r.getColor() && (this.style.color = r.getColor()))
            }
            function n(e) {
                this.children = e || [],
                this.height = 0,
            ...
            function a(e, t, r, n, a, s, o) {
                ...
                this.style = o || {},
                this.maxFontSize = 0,
                i.cjkRegex.test(e) && this.classes.push(i.hangulRegex.test(e) ? "hangul_fallback" : "cjk_fallback"),
                /[\xee\xef\xed\xec]/.test(this.value) && (this.value = l[this.value])
            }
            ...
            r.prototype.toMarkup = function() {
                var e = "<span";
                this.classes.length && (e += ' class="',
                e += s.escape(o(this.classes)),
                e += '"');
                var t = "";
                ...
                for (var n in this.attributes)
                    Object.prototype.hasOwnProperty.call(this.attributes, n) && (e += " " + n + '="',
                    e += s.escape(this.attributes[n]),
                    e += '"');
                e += ">";
            ...
            a.prototype.tryCombine = function(e) {
                if (!e || !(e instanceof a) || this.italic > 0 || o(this.classes) !== o(e.classes) || this.skew !== e.skew || this.maxFontSize !== e.maxFontSize)
                    return !1;
                for (var t in this.style)
            ...
            a.prototype.toNode = function() {
                ...
                for (var r in this.style)
                    this.style.hasOwnProperty(r) && (t = t || document.createElement("span"),
            ...
            a.prototype.toMarkup = function() {
                ...
                t += ' class="',
                t += s.escape(o(this.classes)),
                t += '"');
                var r = "";
                this.italic > 0 && (r += "margin-right:" + this.italic + "em;");
                for (var n in this.style)
                    this.style.hasOwnProperty(n) && (r += s.hyphenate(n) + ":" + this.style[n] + ";");
                r && (e = !0,
                t += ' style="' + s.escape(r) + '"');
        ...
        19: [function(e, t) {
            ...
            r(["\\dfrac", "\\frac", "\\tfrac", "\\dbinom", "\\binom", "\\tbinom", "\\\\atopfrac"], {
                ...
                var r, n = t[0], a = t[1], i = null, s = null, o = "auto";
                switch (e.funcName) {
                case "\\dfrac":
                case "\\frac":
                case "\\tfrac":
            ...
            r(["\\mathrm", "\\mathit", "\\mathbf", "\\mathbb", "\\mathcal", "\\mathfrak", "\\mathscr", "\\mathsf", "\\mathtt", "\\Bbb", "\\bold", "\\frak"], {
                numArgs: 1,
                greediness: 2
            }, function(e, t) {
                var r = t[0]
            ...
            r(["\\begin", "\\end"], {
                ...
                for (var n = "", i = 0; i < r.value.length; ++i)
                    n += r.value[i].value;
                return {
                    type: "environment",
                    name: n,
        ...
        21: [function(e, t) {
            function r(e, t, r, n, a) {
                ...
                this.value = t,
                this.mode = r,
                !n || a && a.lexer !== n.lexer || (this.lexer = n.lexer,
                this.start = n.start,
                this.end = (a || n).end)
            }
            t.exports = {
        ...
        23: [function(e, t) {
            ...
            r(n, i, l, "\u2240", "\\wr"),
            r(n, i, l, "\u2a3f", "\\amalg"),
            r(n, i, f, "\u27f5", "\\longleftarrow"),
            r(n, i, f, "\u21d0", "\\Leftarrow"),
            r(n, i, f, "\u27f8", "\\Longleftarrow"),
            r(n, i, f, "\u27f6", "\\longrightarrow"),
            r(n, i, f, "\u21d2", "\\Rightarrow"),
            r(n, i, f, "\u27f9", "\\Longrightarrow"),
            r(n, i, f, "\u2194", "\\leftrightarrow"),
            r(n, i, f, "\u27f7", "\\longleftrightarrow"),
            r(n, i, f, "\u21d4", "\\Leftrightarrow"),
            r(n, i, f, "\u27fa", "\\Longleftrightarrow"),
            r(n, i, f, "\u21a6", "\\mapsto"),
            r(n, i, f, "\u27fc", "\\longmapsto"),
            r(n, i, f, "\u2197", "\\nearrow"),
            r(n, i, f, "\u21a9", "\\hookleftarrow"),
            r(n, i, f, "\u21aa", "\\hookrightarrow"),
            r(n, i, f, "\u2198", "\\searrow"),
            r(n, i, f, "\u21bc", "\\leftharpoonup"),
            r(n, i, f, "\u21c0", "\\rightharpoonup"),
            r(n, i, f, "\u2199", "\\swarrow"),
            r(n, i, f, "\u21bd", "\\leftharpoondown"),
            r(n, i, f, "\u21c1", "\\rightharpoondown"),
            r(n, i, f, "\u2196", "\\nwarrow"),
            r(n, i, f, "\u21cc", "\\rightleftharpoons"),
            r(n, s, f, "\u226e", "\\nless"),
            r(n, s, f, "\ue010", "\\nleqslant"),
            r(n, s, f, "\ue011", "\\nleqq"),
            r(n, s, f, "\u2a87", "\\lneq"),
            ...
            r(n, s, f, "\u22ec", "\\ntrianglelefteq"),
            r(n, s, f, "\u228a", "\\subsetneq"),
            r(n, s, f, "\ue01a", "\\varsubsetneq"),
            r(n, s, f, "\u2acb", "\\subsetneqq"),
            r(n, s, f, "\ue017", "\\varsubsetneqq"),
            r(n, s, f, "\u226f", "\\ngtr"),
            r(n, s, f, "\ue00f", "\\ngeqslant"),
            r(n, s, f, "\ue00e", "\\ngeqq"),
            r(n, s, f, "\u2a88", "\\gneq"),
            ...
            r(n, s, f, "\ue018", "\\nsupseteqq"),
            r(n, s, f, "\u228b", "\\supsetneq"),
            r(n, s, f, "\ue01b", "\\varsupsetneq"),
            r(n, s, f, "\u2acc", "\\supsetneqq"),
            r(n, s, f, "\ue019", "\\varsupsetneqq"),
            r(n, s, f, "\u22ae", "\\nVdash"),
            r(n, s, f, "\u2ab5", "\\precneqq"),
            r(n, s, f, "\u2ab6", "\\succneqq"),
            r(n, s, f, "\ue016", "\\nsubseteqq"),
            ...
            r(n, s, v, "\u25ca", "\\lozenge"),
            r(n, s, v, "\u24c8", "\\circledS"),
            r(n, s, v, "\xae", "\\circledR"),
            r(n, s, v, "\u2221", "\\measuredangle"),
            r(n, s, v, "\u2204", "\\nexists"),
            r(n, s, v, "\u2127", "\\mho"),
            r(n, s, v, "\u2132", "\\Finv"),
            r(n, s, v, "\u2141", "\\Game"),
            r(n, s, v, "k", "\\Bbbk"),
            r(n, s, v, "\u2035", "\\backprime"),
            r(n, s, v, "\u25b2", "\\blacktriangle"),
            r(n, s, v, "\u25bc", "\\blacktriangledown"),
            r(n, s, v, "\u25a0", "\\blacksquare"),
            r(n, s, v, "\u29eb", "\\blacklozenge"),
            r(n, s, v, "\u2605", "\\bigstar"),
            r(n, s, v, "\u2222", "\\sphericalangle"),
            r(n, s, v, "\u2201", "\\complement"),
            r(n, s, v, "\xf0", "\\eth"),
            r(n, s, v, "\u2571", "\\diagup"),
            r(n, s, v, "\u2572", "\\diagdown"),
            ...
            r(n, s, f, "\u2a8b", "\\lesseqqgtr"),
            r(n, s, f, "\u2251", "\\doteqdot"),
            r(n, s, f, "\u2253", "\\risingdotseq"),
            r(n, s, f, "\u2252", "\\fallingdotseq"),
            r(n, s, f, "\u223d", "\\backsim"),
            r(n, s, f, "\u22cd", "\\backsimeq"),
            r(n, s, f, "\u2ac5", "\\subseteqq"),
            r(n, s, f, "\u22d0", "\\Subset"),
            ...
            r(n, s, f, "\u227e", "\\precsim"),
            r(n, s, f, "\u2ab7", "\\precapprox"),
            r(n, s, f, "\u22b2", "\\vartriangleleft"),
            r(n, s, f, "\u22b4", "\\trianglelefteq"),
            r(n, s, f, "\u22a8", "\\vDash"),
            r(n, s, f, "\u22aa", "\\Vvdash"),
            r(n, s, f, "\u2323", "\\smallsmile"),
            r(n, s, f, "\u2322", "\\smallfrown"),
            ...
            r(n, s, f, "\u227f", "\\succsim"),
            r(n, s, f, "\u2ab8", "\\succapprox"),
            r(n, s, f, "\u22b3", "\\vartriangleright"),
            r(n, s, f, "\u22b5", "\\trianglerighteq"),
            r(n, s, f, "\u22a9", "\\Vdash"),
            r(n, s, f, "\u2223", "\\shortmid"),
            r(n, s, f, "\u2225", "\\shortparallel"),
            r(n, s, f, "\u226c", "\\between"),
            r(n, s, f, "\u22d4", "\\pitchfork"),
            r(n, s, f, "\u221d", "\\varpropto"),
            r(n, s, f, "\u25c0", "\\blacktriangleleft"),
            r(n, s, f, "\u2234", "\\therefore"),
            r(n, s, f, "\u220d", "\\backepsilon"),
            r(n, s, f, "\u25b6", "\\blacktriangleright"),
            r(n, s, f, "\u2235", "\\because"),
            r(n, s, f, "\u22d8", "\\llless"),
            r(n, s, f, "\u22d9", "\\gggtr"),
            r(n, s, l, "\u22b2", "\\lhd"),
            ...
            r(n, s, f, "\u2251", "\\Doteq"),
            r(n, s, l, "\u2214", "\\dotplus"),
            r(n, s, l, "\u2216", "\\smallsetminus"),
            r(n, s, l, "\u22d2", "\\Cap"),
            r(n, s, l, "\u22d3", "\\Cup"),
            r(n, s, l, "\u2a5e", "\\doublebarwedge"),
            r(n, s, l, "\u229f", "\\boxminus"),
            r(n, s, l, "\u229e", "\\boxplus"),
            r(n, s, l, "\u22c7", "\\divideontimes"),
            r(n, s, l, "\u22c9", "\\ltimes"),
            r(n, s, l, "\u22ca", "\\rtimes"),
            r(n, s, l, "\u22cb", "\\leftthreetimes"),
            r(n, s, l, "\u22cc", "\\rightthreetimes"),
            r(n, s, l, "\u22cf", "\\curlywedge"),
            r(n, s, l, "\u22ce", "\\curlyvee"),
            r(n, s, l, "\u229d", "\\circleddash"),
            r(n, s, l, "\u229b", "\\circledast"),
            ...
            r(n, s, l, "\u22d3", "\\doublecup"),
            r(n, s, l, "\u22a0", "\\boxtimes"),
            r(n, s, f, "\u21e2", "\\dashrightarrow"),
            r(n, s, f, "\u21e0", "\\dashleftarrow"),
            r(n, s, f, "\u21c7", "\\leftleftarrows"),
            r(n, s, f, "\u21c6", "\\leftrightarrows"),
            r(n, s, f, "\u21da", "\\Lleftarrow"),
            r(n, s, f, "\u219e", "\\twoheadleftarrow"),
            r(n, s, f, "\u21a2", "\\leftarrowtail"),
            r(n, s, f, "\u21ab", "\\looparrowleft"),
            r(n, s, f, "\u21cb", "\\leftrightharpoons"),
            r(n, s, f, "\u21b6", "\\curvearrowleft"),
            r(n, s, f, "\u21ba", "\\circlearrowleft"),
            r(n, s, f, "\u21b0", "\\Lsh"),
            r(n, s, f, "\u21c8", "\\upuparrows"),
            r(n, s, f, "\u21bf", "\\upharpoonleft"),
            r(n, s, f, "\u21c3", "\\downharpoonleft"),
            r(n, s, f, "\u22b8", "\\multimap"),
            r(n, s, f, "\u21ad", "\\leftrightsquigarrow"),
            r(n, s, f, "\u21c9", "\\rightrightarrows"),
            r(n, s, f, "\u21c4", "\\rightleftarrows"),
            r(n, s, f, "\u21a0", "\\twoheadrightarrow"),
            r(n, s, f, "\u21a3", "\\rightarrowtail"),
            r(n, s, f, "\u21ac", "\\looparrowright"),
            r(n, s, f, "\u21b7", "\\curvearrowright"),
            r(n, s, f, "\u21bb", "\\circlearrowright"),
            r(n, s, f, "\u21b1", "\\Rsh"),
            r(n, s, f, "\u21ca", "\\downdownarrows"),
            r(n, s, f, "\u21be", "\\upharpoonright"),
            r(n, s, f, "\u21c2", "\\downharpoonright"),
            r(n, s, f, "\u21dd", "\\rightsquigarrow"),
            r(n, s, f, "\u21dd", "\\leadsto"),
            r(n, s, f, "\u21db", "\\Rrightarrow"),
            r(n, s, f, "\u21be", "\\restriction"),
            r(n, i, v, "\u2018", "`"),
            ...
            r(n, s, l, "\u229a", "\\circledcirc"),
            r(n, s, l, "\u22a1", "\\boxdot"),
            r(n, i, l, "\u25b3", "\\bigtriangleup"),
            r(n, i, l, "\u25bd", "\\bigtriangledown"),
            r(n, i, l, "\u2020", "\\dagger"),
            r(n, i, l, "\u22c4", "\\diamond"),
            r(n, i, l, "\u22c6", "\\star"),
            r(n, i, l, "\u25c3", "\\triangleleft"),
            r(n, i, l, "\u25b9", "\\triangleright"),
            r(n, i, h, "{", "\\{"),
            r(a, i, v, "{", "\\{"),
            r(n, i, u, "}", "\\}"),
            r(a, i, v, "}", "\\}"),
        ...
        25: [function(e, t) {
            ...
            var i, s = Array.prototype.indexOf, o = function(e, t) {
                if (null == e)
                    return -1;
                if (s && e.indexOf === s)
                    return e.indexOf(t);
        ...
        1: [function(e, t) {
            var r = e("./splitAtDelimiters")
                ...
                for (var r = n(e, t), a = document.createDocumentFragment(), i = 0; i < r.length; i++)
                    if ("text" === r[i].type)
                        ...
                        try {
                            ...
                            if (!(l instanceof katex.ParseError))
                                throw l;
                            console.error("KaTeX auto-render: Failed to parse `" + r[i].data + "` with ", l),
                            a.appendChild(document.createTextNode(r[i].rawData));
                            continue
                        }
                        a.appendChild(s)
                    }
              ...
              , l = function(e, t) {
                ...
                t = o({}, s, t),
                i(e, t.delimiters, t.ignoredTags)
            };
            t.exports = l
        }
        , {
...
function(e, t) {
    ...
    function e(e) {
        if (Wr !== !0)
            if (Wr = !0,
            t(),
            en.transforms2d || en.transforms3d) {
                Qr.wrapper = document.querySelector(".reveal"),
                Qr.slides = document.querySelector(".reveal .slides"),
                window.addEventListener("load", F, !1);
                var n = Mr.getQueryHash();
                "undefined" != typeof n.dependencies && delete n.dependencies,
                g(Xr, e),
                g(Xr, n),
                z(),
                r()
                ...
                for (var a = v(document.getElementsByTagName("img")), i = v(document.getElementsByTagName("iframe")), s = a.concat(i), o = 0, l = s.length; l > o; o++) {
                    var u = s[o];
                    u.getAttribute("data-src") && (u.setAttribute("src", u.getAttribute("data-src")),
                    u.removeAttribute("data-src"))
                }
            }
    }
    function t() {
        Pr = /(iphone|ipod|ipad|android)/gi.test(Vr),
        Rr = /chrome/i.test(Vr) && !/edge/i.test(Vr);
        var e = document.createElement("div");
        en.transforms3d = "WebkitPerspective"in e.style || "MozPerspective"in e.style || "msPerspective"in e.style || "OPerspective"in e.style || "perspective"in e.style,
        en.transforms2d = "WebkitTransform"in e.style || "MozTransform"in e.style || "msTransform"in e.style || "OTransform"in e.style || "transform"in e.style,
        en.requestAnimationFrameMethod = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame,
        en.requestAnimationFrame = "function" == typeof en.requestAnimationFrameMethod,
        en.canvas = !!document.createElement("canvas").getContext,
        en.overviewTransitions = !/Version\/[\d\.]+.*Safari/.test(Vr),
        en.zoom = "zoom"in e.style && !Pr && (Rr || /Version\/[\d\.]+.*Safari/.test(Vr))
    }
    function r() {
        function e() {
            a.length && head.js.apply(null, a),
            n()
        }
        function t(t) {
        ...
        for (var r = [], a = [], i = 0, s = 0, o = Xr.dependencies.length; o > s; s++) {
            ...
            (!l.condition || l.condition()) && (l.async ? a.push(l.src) : r.push(l.src),
            t(l))
        }
        r.length ? (i = r.length,
        head.js.apply(null, r)) : e()
    }
    function n() {
        a(),
        p(),
        ...
        yt(!0),
        setTimeout(function() {
            Qr.slides.classList.remove("no-transition"),
            Ur = !0,
            Qr.wrapper.classList.add("ready"),
            N("ready", {
                indexh: zr,
                indexv: Tr,
                currentSlide: qr
    ...
    function a() {
        Qr.slides.classList.add("no-transition"),
        Pr ? Qr.wrapper.classList.add("no-hover") : Qr.wrapper.classList.remove("no-hover"),
        Qr.background = u(Qr.wrapper, "div", "backgrounds", null),
        Qr.progress = u(Qr.wrapper, "div", "progress", "<span></span>"),
        Qr.progressbar = Qr.progress.querySelector("span"),
        Qr.controls = u(Qr.wrapper, "aside", "controls", '<button class="navigate-left" aria-label="previous slide"><div class="controls-arrow"></div></button><button class="navigate-right" aria-label="next slide"><div class="controls-arrow"></div></button><button class="navigate-up" aria-label="above slide"><div class="controls-arrow"></div></button><button class="navigate-down" aria-label="below slide"><div class="controls-arrow"></div></button>'),
        Qr.slideNumber = u(Qr.wrapper, "div", "slide-number", ""),
        Qr.speakerNotes = u(Qr.wrapper, "div", "speaker-notes", null),
        Qr.speakerNotes.setAttribute("data-prevent-swipe", ""),
        Qr.speakerNotes.setAttribute("tabindex", "0"),
        u(Qr.wrapper, "div", "pause-overlay", null),
        Qr.wrapper.setAttribute("role", "application"),
        Qr.controlsLeft = v(document.querySelectorAll(".navigate-left")),
        Qr.controlsRight = v(document.querySelectorAll(".navigate-right")),
        Qr.controlsUp = v(document.querySelectorAll(".navigate-up")),
        Qr.controlsDown = v(document.querySelectorAll(".navigate-down")),
        Qr.controlsPrev = v(document.querySelectorAll(".navigate-prev")),
        Qr.controlsNext = v(document.querySelectorAll(".navigate-next")),
        Qr.controlsRightArrow = Qr.controls.querySelector(".navigate-right"),
        Qr.controlsDownArrow = Qr.controls.querySelector(".navigate-down"),
        Qr.statusDiv = i()
    }
    function i() {
        ...
        e.setAttribute("id", "aria-status-div"),
        e.setAttribute("aria-live", "polite"),
        e.setAttribute("aria-atomic", "true"),
        Qr.wrapper.appendChild(e)),
        e
    }
    function s(e) {
        var t = "";
    ...
    function o() {
        var e = V(window.innerWidth, window.innerHeight)
          ...
          , n = e.width
          , a = e.height;
        k("@page{size:" + t + "px " + r + "px; margin: 0px;}"),
        k(".reveal section>img, .reveal section>video, .reveal section>iframe{max-width: " + n + "px; max-height:" + a + "px}"),
        ...
        v(Qr.wrapper.querySelectorAll(Br)).forEach(function(e, t) {
            ...
            e.classList.contains("stack") && v(e.querySelectorAll("section")).forEach(function(e, r) {
                e.setAttribute("data-index-h", t),
                e.setAttribute("data-index-v", r)
            })
        }),
        v(Qr.wrapper.querySelectorAll(Or)).forEach(function(e) {
            if (e.classList.contains("stack") === !1) {
                ...
                l = Math.min(l, Xr.pdfMaxPagesPerSlide),
                (1 === l && Xr.center || e.classList.contains("center")) && (s = Math.max((r - o) / 2, 0));
                var u = document.createElement("div");
                if (u.className = "pdf-page",
                u.style.height = (r + Xr.pdfPageHeightOffset) * l + "px",
                e.parentNode.insertBefore(u, e),
                u.appendChild(e),
                e.style.left = i + "px",
                e.style.top = s + "px",
                e.style.width = n + "px",
                e.slideBackgroundElement && u.insertBefore(e.slideBackgroundElement, e),
                Xr.showNotes) {
                    var c = Ft(e);
                    if (c) {
                        var d = 8
                        ...
                        h.classList.add("speaker-notes"),
                        h.classList.add("speaker-notes-pdf"),
                        h.setAttribute("data-layout", p),
                        h.innerHTML = c,
                        "separate-page" === p ? u.parentNode.insertBefore(h, u.nextSibling) : (h.style.left = d + "px",
                        h.style.bottom = d + "px",
                        h.style.width = t - 2 * d + "px",
                        u.appendChild(h))
                    }
                }
    ...
    function l() {
        setInterval(function() {
            (0 !== Qr.wrapper.scrollTop || 0 !== Qr.wrapper.scrollLeft) && (Qr.wrapper.scrollTop = 0,
            Qr.wrapper.scrollLeft = 0)
        }, 1e3)
    }
    function u(e, t, r, n) {
        ...
        "string" == typeof n && (o.innerHTML = n),
        e.appendChild(o),
        o
    }
    function c() {
        M();
        Qr.background.innerHTML = "",
        Qr.background.classList.add("no-transition"),
        v(Qr.wrapper.querySelectorAll(Br)).forEach(function(e) {
        ...
        Xr.parallaxBackgroundImage ? (Qr.background.style.backgroundImage = 'url("' + Xr.parallaxBackgroundImage + '")',
        Qr.background.style.backgroundSize = Xr.parallaxBackgroundSize,
        setTimeout(function() {
            Qr.wrapper.classList.add("has-parallax-background")
        }, 1)) : (Qr.background.style.backgroundImage = "",
        Qr.wrapper.classList.remove("has-parallax-background"))
    }
    function d(e, t) {
        var r = {
        ...
        r.background && (/^(http|file|\/\/)/gi.test(r.background) || /\.(svg|png|jpg|jpeg|gif|bmp)([?#]|$)/gi.test(r.background) ? e.setAttribute("data-background-image", r.background) : n.style.background = r.background),
        (r.background || r.backgroundColor || r.backgroundImage || r.backgroundVideo || r.backgroundIframe) && n.setAttribute("data-background-hash", r.background + r.backgroundSize + r.backgroundImage + r.backgroundVideo + r.backgroundIframe + r.backgroundColor + r.backgroundRepeat + r.backgroundPosition + r.backgroundTransition),
        r.backgroundSize && (n.style.backgroundSize = r.backgroundSize),
        r.backgroundSize && n.setAttribute("data-background-size", r.backgroundSize),
        r.backgroundColor && (n.style.backgroundColor = r.backgroundColor),
        r.backgroundRepeat && (n.style.backgroundRepeat = r.backgroundRepeat),
        r.backgroundPosition && (n.style.backgroundPosition = r.backgroundPosition),
        r.backgroundTransition && n.setAttribute("data-background-transition", r.backgroundTransition),
        t.appendChild(n),
    ...
    function p() {
        Xr.postMessage && window.addEventListener("message", function(e) {
            var t = e.data;
            "string" == typeof t && "{" === t.charAt(0) && "}" === t.charAt(t.length - 1) && (t = JSON.parse(t),
            t.method && "function" == typeof Mr[t.method] && Mr[t.method].apply(Mr, t.args))
        }, !1)
    }
    function h(e) {
        var t = Qr.wrapper.querySelectorAll(Or).length;
        Qr.wrapper.classList.remove(Xr.transition),
        "object" == typeof e && g(Xr, e),
        en.transforms3d === !1 && (Xr.transition = "linear"),
        Qr.wrapper.classList.add(Xr.transition),
        Qr.wrapper.setAttribute("data-transition-speed", Xr.transitionSpeed),
        Qr.wrapper.setAttribute("data-background-transition", Xr.backgroundTransition),
        Qr.controls.style.display = Xr.controls ? "block" : "none",
        Qr.progress.style.display = Xr.progress ? "block" : "none",
        Qr.controls.setAttribute("data-controls-layout", Xr.controlsLayout),
        Qr.controls.setAttribute("data-controls-back-arrows", Xr.controlsBackArrows),
        Xr.shuffle && lt(),
        Xr.rtl ? Qr.wrapper.classList.add("rtl") : Qr.wrapper.classList.remove("rtl"),
        Xr.center ? Qr.wrapper.classList.add("center") : Qr.wrapper.classList.remove("center"),
        Xr.pause === !1 && Q(),
        Xr.showNotes && Qr.speakerNotes.setAttribute("data-layout", "string" == typeof Xr.showNotes ? Xr.showNotes : "inline"),
        Xr.mouseWheel ? (document.addEventListener("DOMMouseScroll", pr, !1),
        document.addEventListener("mousewheel", pr, !1)) : (document.removeEventListener("DOMMouseScroll", pr, !1),
        document.removeEventListener("mousewheel", pr, !1)),
        Xr.rollingLinks ? q() : C(),
        Xr.previewLinks ? (P(),
        R("[data-preview-link=false]")) : (R(),
        P("[data-preview-link]:not([data-preview-link=false])")),
        Dr && (Dr.destroy(),
        Dr = null),
        t > 1 && Xr.autoSlide && Xr.autoSlideStoppable && en.canvas && en.requestAnimationFrame && (Dr = new Lr(Qr.wrapper,function() {
            return Math.min(Math.max((Date.now() - on) / an, 0), 1)
        }
        ),
        Dr.on("click", Er),
        ln = !1),
        Xr.fragments === !1 && v(Qr.slides.querySelectorAll(".fragment")).forEach(function(e) {
            e.classList.add("visible"),
            e.classList.remove("current-fragment")
        });
        var r = "none";
        Xr.slideNumber && !M() && ("all" === Xr.showSlideNumber ? r = "block" : "speaker" === Xr.showSlideNumber && qt() && (r = "block")),
        Qr.slideNumber.style.display = r,
        it()
    }
    function m() {
        if (nn = !0,
        window.addEventListener("hashchange", wr, !1),
        window.addEventListener("resize", xr, !1),
        Xr.touch && (Qr.wrapper.addEventListener("touchstart", sr, !1),
        Qr.wrapper.addEventListener("touchmove", or, !1),
        Qr.wrapper.addEventListener("touchend", lr, !1),
        window.navigator.pointerEnabled ? (Qr.wrapper.addEventListener("pointerdown", ur, !1),
        Qr.wrapper.addEventListener("pointermove", cr, !1),
        Qr.wrapper.addEventListener("pointerup", dr, !1)) : window.navigator.msPointerEnabled && (Qr.wrapper.addEventListener("MSPointerDown", ur, !1),
        Qr.wrapper.addEventListener("MSPointerMove", cr, !1),
        Qr.wrapper.addEventListener("MSPointerUp", dr, !1))),
        Xr.keyboard && (document.addEventListener("keydown", ir, !1),
        document.addEventListener("keypress", ar, !1)),
        Xr.progress && Qr.progress && Qr.progress.addEventListener("click", hr, !1),
        Xr.focusBodyOnPageVisibilityChange) {
            var e;
            "hidden"in document ? e = "visibilitychange" : "msHidden"in document ? e = "msvisibilitychange" : "webkitHidden"in document && (e = "webkitvisibilitychange"),
            e && document.addEventListener(e, kr, !1)
        }
        var t = ["touchstart", "click"];
        Vr.match(/android/gi) && (t = ["touchstart"]),
    ...
    function f() {
        nn = !1,
        document.removeEventListener("keydown", ir, !1),
        document.removeEventListener("keypress", ar, !1),
        window.removeEventListener("hashchange", wr, !1),
        window.removeEventListener("resize", xr, !1),
        Qr.wrapper.removeEventListener("touchstart", sr, !1),
        Qr.wrapper.removeEventListener("touchmove", or, !1),
        Qr.wrapper.removeEventListener("touchend", lr, !1),
        window.navigator.pointerEnabled ? (Qr.wrapper.removeEventListener("pointerdown", ur, !1),
        Qr.wrapper.removeEventListener("pointermove", cr, !1),
        Qr.wrapper.removeEventListener("pointerup", dr, !1)) : window.navigator.msPointerEnabled && (Qr.wrapper.removeEventListener("MSPointerDown", ur, !1),
        Qr.wrapper.removeEventListener("MSPointerMove", cr, !1),
        Qr.wrapper.removeEventListener("MSPointerUp", dr, !1)),
        Xr.progress && Qr.progress && Qr.progress.removeEventListener("click", hr, !1),
    ...
    function x(e) {
        "string" == typeof e.layout && (Zr.layout = e.layout),
        "string" == typeof e.overview && (Zr.overview = e.overview),
        Zr.layout ? w(Qr.slides, Zr.layout + " " + Zr.overview) : w(Qr.slides, Zr.overview)
    }
    function k(e) {
    ...
    function E(e) {
        ...
        e ? (299 * e.r + 587 * e.g + 114 * e.b) / 1e3 : null
    }
    function L(e, t) {
        if (t = t || 0,
        e) {
    ...
    function z() {
        Xr.hideAddressBar && Pr && (window.addEventListener("load", T, !1),
    ...
    function N(e, t) {
        ...
        r.initEvent(e, !0, !0),
        g(r, t),
        Qr.wrapper.dispatchEvent(r),
        Xr.postMessageEvents && window.parent !== window.self && window.parent.postMessage(JSON.stringify({
            namespace: "reveal",
            eventName: e,
            state: Ht()
        }), "*")
        ...
        if (en.transforms3d && !("msPerspective"in document.body.style))
            for (var e = Qr.wrapper.querySelectorAll(Or + " a"), t = 0, r = e.length; r > t; t++) {
                ...
                if (!(!n.textContent || n.querySelector("*") || n.className && n.classList.contains(n, "roll"))) {
                    ...
                    a.setAttribute("data-title", n.text),
    ...
    function D(e) {
        B(),
        Qr.overlay = document.createElement("div"),
        Qr.overlay.classList.add("overlay"),
        Qr.overlay.classList.add("overlay-preview"),
        Qr.wrapper.appendChild(Qr.overlay),
        Qr.overlay.innerHTML = ["<header>", '<a class="close" href="#"><span class="icon"></span></a>', '<a class="external" href="' + e + '" target="_blank"><span class="icon"></span></a>', "</header>", '<div class="spinner"></div>', '<div class="viewport">', '<iframe src="' + e + '"></iframe>', '<small class="viewport-inner">', '<span class="x-frame-error">Unable to load iframe. This is likely due to the site\'s policy (x-frame-options).</span>', "</small>", "</div>"].join(""),
        Qr.overlay.querySelector("iframe").addEventListener("load", function() {
            Qr.overlay.classList.add("loaded")
        }, !1),
        Qr.overlay.querySelector(".close").addEventListener("click", function(e) {
            B(),
            e.preventDefault()
        }, !1),
        Qr.overlay.querySelector(".external").addEventListener("click", function() {
            B()
        }, !1),
        setTimeout(function() {
    ...
    function O() {
        if (Xr.help) {
            ...
            Qr.overlay = document.createElement("div"),
            Qr.overlay.classList.add("overlay"),
            Qr.overlay.classList.add("overlay-help"),
            Qr.wrapper.appendChild(Qr.overlay);
            var e = '<p class="title">Keyboard Shortcuts</p><br/>';
            e += "<table><th>KEY</th><th>ACTION</th>";
            for (var t in cn)
                e += "<tr><td>" + t + "</td><td>" + cn[t] + "</td></tr>";
            e += "</table>",
            Qr.overlay.innerHTML = ["<header>", '<a class="close" href="#"><span class="icon"></span></a>', "</header>", '<div class="viewport">', '<div class="viewport-inner">' + e + "</div>", "</div>"].join(""),
            Qr.overlay.querySelector(".close").addEventListener("click", function(e) {
                B(),
                e.preventDefault()
            }, !1),
    ...
    function B() {
        Qr.overlay && (Qr.overlay.parentNode.removeChild(Qr.overlay),
        Qr.overlay = null)
    }
    function F() {
        if (Qr.wrapper && !M()) {
            ...
            x({
                layout: ""
            })) : (Qr.slides.style.zoom = "",
            Qr.slides.style.left = "50%",
            Qr.slides.style.top = "50%",
        ...
        v(Qr.slides.querySelectorAll("section > .stretch")).forEach(function(r) {
            ...
            if (/(img|video)/gi.test(r.nodeName)) {
                var a = r.naturalWidth || r.videoWidth
                  ...
                  , s = Math.min(e / a, n / i);
                r.style.width = a * s + "px",
                r.style.height = i * s + "px"
            } else
                r.style.width = e + "px",
                r.style.height = n + "px"
        })
    ...
    function V(e, t) {
        ...
        return r.presentationWidth -= r.presentationWidth * Xr.margin,
        r.presentationHeight -= r.presentationHeight * Xr.margin,
        "string" == typeof r.width && /%$/.test(r.width) && (r.width = parseInt(r.width, 10) / 100 * r.presentationWidth),
        "string" == typeof r.height && /%$/.test(r.height) && (r.height = parseInt(r.height, 10) / 100 * r.presentationHeight),
        r
    }
    function X(e, t) {
    ...
    function U() {
        if (Xr.overview && !$()) {
            jr = !0,
            Qr.wrapper.classList.add("overview"),
            Qr.wrapper.classList.remove("overview-deactivating"),
            en.overviewTransitions && setTimeout(function() {
                Qr.wrapper.classList.add("overview-animated")
            }, 1),
            Gt(),
            Qr.slides.appendChild(Qr.background),
            v(Qr.wrapper.querySelectorAll(Or)).forEach(function(e) {
    ...
    function j() {
        v(Qr.wrapper.querySelectorAll(Br)).forEach(function(e, t) {
            e.setAttribute("data-index-h", t),
            w(e, "translate3d(" + t * _r + "px, 0, 0)"),
            e.classList.contains("stack") && v(e.querySelectorAll("section")).forEach(function(e, r) {
                e.setAttribute("data-index-h", t),
                e.setAttribute("data-index-v", r),
                w(e, "translate3d(0, " + r * Gr + "px, 0)")
            })
        }),
        v(Qr.background.childNodes).forEach(function(e, t) {
            w(e, "translate3d(" + t * _r + "px, 0, 0)"),
            v(e.querySelectorAll(".slide-background")).forEach(function(e, t) {
    ...
    function G() {
        Xr.overview && (jr = !1,
        Qr.wrapper.classList.remove("overview"),
        Qr.wrapper.classList.remove("overview-animated"),
        Qr.wrapper.classList.add("overview-deactivating"),
        setTimeout(function() {
            Qr.wrapper.classList.remove("overview-deactivating")
        }, 1),
        Qr.wrapper.appendChild(Qr.background),
        v(Qr.wrapper.querySelectorAll(Or)).forEach(function(e) {
            w(e, ""),
            e.removeEventListener("click", Ar, !0)
        }),
    ...
    function Z() {
        if (Xr.pause) {
            ...
            Gt(),
            Qr.wrapper.classList.add("paused"),
            e === !1 && N("paused")
        }
    }
    function Q() {
        var e = Qr.wrapper.classList.contains("paused");
        Qr.wrapper.classList.remove("paused"),
        _t(),
        e && N("resumed")
    }
    function et(e) {
    ...
    function at(e, t, r, n) {
        ...
        if (0 !== a.length) {
            void 0 !== t || $() || (t = W(a[e])),
            Nr && Nr.parentNode && Nr.parentNode.classList.contains("stack") && X(Nr.parentNode, Tr);
            var i = Kr.concat();
            Kr.length = 0;
            var o = zr || 0
              , l = Tr || 0;
            zr = ut(Br, void 0 === e ? zr : e),
            Tr = ut(Fr, void 0 === t ? Tr : t),
            ct(),
            F();
            e: for (var u = 0, c = Kr.length; c > u; u++) {
                ...
                document.documentElement.classList.add(Kr[u]),
                N(Kr[u])
            }
            for (; i.length; )
                document.documentElement.classList.remove(i.pop());
            $() && _();
            var p = a[zr]
              , h = p.querySelectorAll("section");
            qr = h[Tr] || p,
            "undefined" != typeof r && Wt(r);
            var m = zr !== o || Tr !== l;
            m ? N("slidechanged", {
                indexh: zr,
                indexv: Tr,
            ...
            Nr && (Nr.classList.remove("present"),
            Nr.setAttribute("aria-hidden", "true"),
            Qr.wrapper.querySelector(Hr).classList.contains("present") && setTimeout(function() {
    ...
    function it() {
        ...
        dt(),
        St(),
        Xr.autoPlayMedia === !1 ? zt(qr) : Et(qr),
        $() && j()
    }
    function st() {
        ...
        if (n) {
            ...
            for (var i = 0; n > i; i++) {
                ...
                a)
                    ...
                    if (s.classList.add(o ? "future" : "past"),
                    Xr.fragments)
                        for (var l = v(s.querySelectorAll(".fragment")); l.length; ) {
                            var u = l.pop();
                            u.classList.add("visible"),
                            u.classList.remove("current-fragment")
                        }
                } else if (i > t && (s.classList.add(o ? "past" : "future"),
                Xr.fragments))
            ...
            r[t].classList.add("present"),
            r[t].removeAttribute("hidden"),
            r[t].removeAttribute("aria-hidden");
    ...
    function ct() {
        var e, t, r = v(Qr.wrapper.querySelectorAll(Br)), n = r.length;
        if (n && "undefined" != typeof zr) {
            ...
            for (var i = 0; n > i; i++) {
                var s = r[i]
                  ...
                  , l = o.length;
                if (e = Math.abs((zr || 0) - i) || 0,
                Xr.loop && (e = Math.abs(((zr || 0) - i) % (n - a)) || 0),
                a > e ? wt(s) : xt(s),
                l)
                    for (var u = W(s), c = 0; l > c; c++) {
                        var d = o[c];
                        t = Math.abs(i === (zr || 0) ? (Tr || 0) - c : c - u),
                        a > e + t ? wt(d) : xt(d)
                    }
            }
            Qr.wrapper.querySelectorAll(".slides>section>section").length ? Qr.wrapper.classList.add("has-vertical-slides") : Qr.wrapper.classList.remove("has-vertical-slides"),
            Qr.wrapper.querySelectorAll(".slides>section:not(.stack)").length ? Qr.wrapper.classList.add("has-horizontal-slides") : Qr.wrapper.classList.remove("has-horizontal-slides")
        }
    }
    function dt() {
    ...
    function ft() {
        if (Xr.slideNumber && Qr.slideNumber) {
            var e = []
              , t = "h.v";
            switch ("string" == typeof Xr.slideNumber && (t = Xr.slideNumber),
            t) {
            case "c":
                e.push(Tt() + 1);
                break;
    ...
    function vt() {
        ...
        Xr.controlsTutorial && (!$r && e.down ? Qr.controlsDownArrow.classList.add("highlight") : (Qr.controlsDownArrow.classList.remove("highlight"),
        !Yr && e.right && 0 === Tr ? Qr.controlsRightArrow.classList.add("highlight") : Qr.controlsRightArrow.classList.remove("highlight")))
    }
    function yt(e) {
        var t = null
        ...
        if (v(Qr.background.childNodes).forEach(function(a, i) {
            ...
            zr > i ? a.classList.add(r) : i > zr ? a.classList.add(n) : (a.classList.add("present"),
            t = a),
            (e || i === zr) && v(a.querySelectorAll(".slide-background")).forEach(function(e, r) {
                e.classList.remove("past"),
                e.classList.remove("present"),
                e.classList.remove("future"),
                Tr > r ? e.classList.add("past") : r > Tr ? e.classList.add("future") : (e.classList.add("present"),
                i === zr && (t = e))
            })
        }),
        Cr && zt(Cr),
        t) {
            ...
            /\.gif/i.test(a) && (t.style.backgroundImage = "",
            ...
            s && s === i && t !== Cr && Qr.background.classList.add("no-transition"),
            Cr = t
        }
    ...
    function bt() {
        if (Xr.parallaxBackgroundImage) {
            var e, t, r = Qr.wrapper.querySelectorAll(Br), n = Qr.wrapper.querySelectorAll(Fr), a = Qr.background.style.backgroundSize.split(" ");
            1 === a.length ? e = t = parseInt(a[0], 10) : (e = parseInt(a[0], 10),
            t = parseInt(a[1], 10));
            var i, s, o = Qr.background.offsetWidth, l = r.length;
            i = "number" == typeof Xr.parallaxBackgroundHorizontal ? Xr.parallaxBackgroundHorizontal : l > 1 ? (e - o) / (l - 1) : 0,
            s = i * zr * -1;
            var u, c, d = Qr.background.offsetHeight, p = n.length;
            u = "number" == typeof Xr.parallaxBackgroundVertical ? Xr.parallaxBackgroundVertical : (t - d) / (p - 1),
            c = p > 0 ? u * Tr : 0,
            Qr.background.style.backgroundPosition = s + "px " + -c + "px"
        }
    }
    function wt(e) {
        e.style.display = Xr.display,
        v(e.querySelectorAll("img[data-src], video[data-src], audio[data-src]")).forEach(function(e) {
        ...
        r.hasAttribute("data-loaded") === !1)) {
            ...
            if (n)
                ...
                /autoplay=(1|true|yes)/gi.test(o) ? u.setAttribute("data-src", o) : u.setAttribute("src", o),
                u.style.width = "100%",
                u.style.height = "100%",
    ...
    function Et(e) {
        ...
        v(e.querySelectorAll("video, audio")).forEach(function(e) {
            if (!A(e, ".fragment") || A(e, ".fragment.visible")) {
                ...
                "boolean" != typeof t && (t = e.hasAttribute("data-autoplay") || !!A(e, ".slide-background")),
                t && "function" == typeof e.play && (e.readyState > 1 ? Lt({
                    target: e
                }) : (e.removeEventListener("loadeddata", Lt),
                e.addEventListener("loadeddata", Lt)))
            }
        }),
        ...
        v(e.querySelectorAll("iframe[data-src]")).forEach(function(e) {
            (!A(e, ".fragment") || A(e, ".fragment.visible")) && e.getAttribute("src") !== e.getAttribute("data-src") && (e.removeEventListener("load", Mt),
            e.addEventListener("load", Mt),
            e.setAttribute("src", e.getAttribute("data-src")))
        }))
    }
    function Lt(e) {
        ...
        t && r && (e.target.currentTime = 0,
        e.target.play()),
        e.target.removeEventListener("loadeddata", Lt)
    }
    function Mt(e) {
        var t = e.target;
        if (t && t.contentWindow) {
            ...
            if (r && n) {
                ...
                "boolean" != typeof a && (a = t.hasAttribute("data-autoplay") || !!A(t, ".slide-background")),
                /youtube\.com\/embed\//.test(t.getAttribute("src")) && a ? t.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*") : /player\.vimeo\.com\//.test(t.getAttribute("src")) && a ? t.contentWindow.postMessage('{"method":"play"}', "*") : t.contentWindow.postMessage("slide:start", "*")
            }
        }
    }
    function zt(e) {
    ...
    function Tt() {
        ...
        e: for (var r = 0; r < e.length; r++) {
            for (var n = e[r], a = v(n.querySelectorAll("section")), i = 0; i < a.length; i++) {
                if (a[i].classList.contains("present"))
                    break e;
                t++
            }
            if (n.classList.contains("present"))
                break;
    ...
    function Ct() {
        ...
        if (isNaN(parseInt(t[0], 10)) && r.length) {
            var n;
            if (/^[a-zA-Z][\w:.-]*$/.test(r) && (n = document.getElementById(r)),
            n) {
    ...
    function Pt(e) {
        if (Xr.history)
            ...
            "number" == typeof e)
                ...
                r && (r = r.replace(/[^a-zA-Z0-9\-\_\:\.]/g, "")),
                "string" == typeof r && r.length ? t = "/" + r : ((zr > 0 || Tr > 0) && (t += zr),
                Tr > 0 && (t += "/" + Tr)),
    ...
    function Rt(e) {
        ...
        if (e) {
            ...
            r = Math.max(s.indexOf(i), 0),
            n = void 0,
            a && (n = Math.max(v(e.parentNode.querySelectorAll("section")).indexOf(e), 0))
        }
        if (!e && qr) {
        ...
        if (qr && Xr.fragments) {
            ...
            if (r.length) {
                ...
                return v(r).forEach(function(t, r) {
                    ...
                    e >= r ? (t.classList.contains("visible") || a.push(t),
                    t.classList.add("visible"),
                    t.classList.remove("current-fragment"),
                    Qr.statusDiv.textContent = s(t),
                    r === e && (t.classList.add("current-fragment"),
                    Et(t))) : (t.classList.contains("visible") && i.push(t),
    ...
    function _t() {
        ...
        qr) {
            ...
            an = t ? parseInt(t, 10) : n ? parseInt(n, 10) : r ? parseInt(r, 10) : Xr.autoSlide,
            0 === qr.querySelectorAll(".fragment").length && v(qr.querySelectorAll("video, audio")).forEach(function(e) {
            ...
            !an || ln || tt() || $() || Mr.isLastSlide() && !At().next && Xr.loop !== !0 || (sn = setTimeout(function() {
                "function" == typeof Xr.autoSlideMethod ? Xr.autoSlideMethod() : tr(),
                _t()
            }, an),
            on = Date.now()),
            Dr && Dr.setPlaying(-1 !== sn)
        }
    }
    function Gt() {
        clearTimeout(sn),
    ...
    function Jt() {
        Yr = !0,
        Xr.rtl ? ($() || jt() === !1) && kt().right && at(zr - 1) : ($() || Ut() === !1) && kt().right && at(zr + 1)
    }
    function Zt() {
    ...
    function ir(e) {
        if ("function" == typeof Xr.keyboardCondition && Xr.keyboardCondition() === !1)
            return !0;
        var t = ln;
        nr(e);
        ...
        if (!(r || n || a || e.shiftKey && 32 !== e.keyCode || e.altKey || e.ctrlKey || e.metaKey)) {
            ...
            if ("object" == typeof Xr.keyboard)
                for (i in Xr.keyboard)
                    "togglePause" === Xr.keyboard[i] && s.push(parseInt(i, 10));
            if (tt() && -1 === s.indexOf(e.keyCode))
                return !1;
            var o = !1;
            if ("object" == typeof Xr.keyboard)
                for (i in Xr.keyboard)
                    if (parseInt(i, 10) === e.keyCode) {
                        var l = Xr.keyboard[i];
                        "function" == typeof l ? l.apply(null, [e]) : "string" == typeof l && "function" == typeof Mr[l] && Mr[l].call(),
                        o = !0
                    }
            if (o === !1)
                switch (o = !0,
            ...
            o ? e.preventDefault && e.preventDefault() : 27 !== e.keyCode && 79 !== e.keyCode || !en.transforms3d || (Qr.overlay ? B() : Y(),
            e.preventDefault && e.preventDefault()),
            _t()
        }
    }
    function sr(e) {
        return rr(e.target) ? !0 : (un.startX = e.touches[0].clientX,
        un.startY = e.touches[0].clientY,
        un.startCount = e.touches.length,
        void (2 === e.touches.length && Xr.overview && (un.startSpan = b({
    ...
    function or(e) {
        if (rr(e.target))
            return !0;
        if (un.captured)
            Vr.match(/android/gi) && e.preventDefault();
        else {
            nr(e);
            ...
            if (2 === e.touches.length && 2 === un.startCount && Xr.overview) {
                ...
                Math.abs(un.startSpan - n) > un.threshold && (un.captured = !0,
                n < un.startSpan ? U() : G()),
                e.preventDefault()
            } else if (1 === e.touches.length && 2 !== un.startCount) {
                var a = t - un.startX
                  , i = r - un.startY;
                a > un.threshold && Math.abs(a) > Math.abs(i) ? (un.captured = !0,
                Kt()) : a < -un.threshold && Math.abs(a) > Math.abs(i) ? (un.captured = !0,
                Jt()) : i > un.threshold ? (un.captured = !0,
                Zt()) : i < -un.threshold && (un.captured = !0,
                Qt()),
                Xr.embedded ? (un.captured || K(qr)) && e.preventDefault() : e.preventDefault()
            }
        }
    }
    function lr() {
    ...
    function kr() {
        ...
        e === !1 && document.activeElement !== document.body && ("function" == typeof document.activeElement.blur && document.activeElement.blur(),
        document.body.focus())
    }
    function Ar(e) {
        if (nn && $()) {
            ...
            for (var t = e.target; t && !t.nodeName.match(/section/gi); )
                t = t.parentNode;
            if (t && !t.classList.contains("disabled") && (G(),
    ...
    function Er() {
        Mr.isLastSlide() && Xr.loop === !1 ? (at(0, 0),
        $t()) : ln ? $t() : Yt()
    }
    function Lr(e, t) {
        this.diameter = 100,
    ...
    var Mr, zr, Tr, Nr, qr, Cr, Pr, Rr, Dr, Ir = "3.5.0", Or = ".slides section", Br = ".slides>section", Fr = ".slides>section.present>section", Hr = ".slides>section:first-of-type", Vr = navigator.userAgent, Xr = {
        width: 960,
        height: 700,
        margin: .1,
        minScale: .2,
        ...
        display: "block",
        dependencies: []
    }, Wr = !1, Ur = !1, jr = !1, _r = null, Gr = null, Yr = !1, $r = !1, Kr = [], Jr = 1, Zr = {
        layout: "",
        overview: ""
    }, Qr = {}, en = {}, tn = 0, rn = 0, nn = !1, an = 0, sn = 0, on = -1, ln = !1, un = {
        startX: 0,
        startY: 0,
        startSpan: 0,
        startCount: 0,
    ...
    Lr.prototype.animate = function() {
        ...
        this.render(),
        this.playing && en.requestAnimationFrameMethod.call(window, this.animate.bind(this))
    }
    ,
    Lr.prototype.render = function() {
        ...
        this.context.arc(r, n, t + 4, 0, 2 * Math.PI, !1),
        this.context.fillStyle = "rgba( 0, 0, 0, 0.4 )",
        this.context.fill(),
        this.context.beginPath(),
        this.context.arc(r, n, t, 0, 2 * Math.PI, !1),
        this.context.lineWidth = this.thickness,
        this.context.strokeStyle = "#666",
        this.context.stroke(),
        this.playing && (this.context.beginPath(),
        this.context.arc(r, n, t, s, i, !1),
        this.context.lineWidth = this.thickness,
        this.context.strokeStyle = "#fff",
        this.context.stroke()),
        this.context.translate(r - a / 2, n - a / 2),
        this.playing ? (this.context.fillStyle = "#fff",
        this.context.fillRect(0, 0, a / 2 - 4, a),
        this.context.fillRect(a / 2 + 4, 0, a / 2 - 4, a)) : (this.context.beginPath(),
        this.context.translate(4, 0),
        this.context.moveTo(0, 0),
        this.context.lineTo(a - 4, a / 2),
